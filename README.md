...
8. Run the commands one by one for getting your database. (Make sure to change the directory of the folder used in this code. Currently it is using  'test/', either change the directorry or add all your pdfs to a folder named as test and then run the notebook)
